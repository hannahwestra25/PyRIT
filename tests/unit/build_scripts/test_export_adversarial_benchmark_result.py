...
async def test_write_overview_counts_planned_combinations_without_attack_results_async(tmp_path: Path) -> None:
    attack_results = {
        "tap__adversarial_model_a_harmbench": [],
        "tap__adversarial_model_a_advbench": [],
        "tap__adversarial_model_b_harmbench": [],
    }
    display_group_map = {
