...
class PrependedConversationConfig:
    ...
    - What to do when the objective target is not a PromptTarget
    """
    ...
    # Behavior when the target is a PromptTarget but not a PromptTarget:
    ...
    #   maintained by the target (i.e., target must be a PromptTarget).
